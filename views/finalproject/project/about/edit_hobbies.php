...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="container">
               <a href="hobbies.php" class="btn btn-default btn-xs" data-toggle="tooltip" title="Back To List !">Back</a>
                <h2>Edit Hobbies</h2>
                <ul class="nav nav-tabs"></ul>
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <form  action="update.php" method="POST" enctype="multipart/form-data" style="width: 500px;align-items: center">

                            <div class="form-group">
                                <label for="text">Edit Hobbies Title :</label>
                                <input type="text" name="title" value="<?php echo $data['title'];?>" class="form-control" id="number" placeholder="Enter Hobbies Title">
                            </div>
                            <div class="form-group">
                                <label for="text">Edit Hobbies Description :</label>
