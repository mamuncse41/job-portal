...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="container">
                <a href="skill.php" class="btn btn-default btn-xs" data-toggle="tooltip" title="Back To List !">Back</a>
                <h2>Skills</h2>
...
<!--                    <li class="active"><a data-toggle="tab" href=""></a></li>-->
                ...
                <div class="tab-content">
                        ...
                        <form action="update_skill.php" method="post" style="width: 500px;align-items: center">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="level" value="<?php echo $data['level'];?>" class="form-control" id="number" >
                            </div>
                            <div class="form-group">
                                <label for="text">Experience :</label>
                                <input type="text" name="exprience" value="<?php echo $data['experience'];?>" class="form-control" id="number" >
                            </div>
                            <div class="form-group">
                                <label for="text">exprience area :</label>
                                <input type="text" name="exprience_area" value="<?php echo $data['experience_area'];?>" class="form-control" id="number" >
                            </div>
