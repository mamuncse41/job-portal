                    ...
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="skill.php">Add Skill </a></li>
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">View Skills</a></li>
                    <!--                    <li><a data-toggle="tab" href="#menu1">  View About </a></li>-->
                    <li><a data-toggle="tab" href="#menu2">Add Skills</a></li>
                ...
                <div class="tab-content">
                            ...
                            <div class="table table-bordered" >
                                <table class="table" style="border: 1px solid #eee8d5"  >
                                    ...
                                    <tr>
                                        ...
                                        <td width="160px">
                                            <a href="edit_skill.php?id=<?php echo $value['id']; ?>"><input type="submit" value="Edit" class="btn btn-info"></a>
                                            <a href="delete_skill.php?id=<?php echo $value['id'];?>"> <input type="submit" value="delete"  class="btn btn-danger"/></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    </tbody>
                    ...
                    <div id="menu2" class="tab-pane fade">
                        <form  action="store_skill.php" method="post" style="width: 500px;align-items: center">
                            <div class="form-group">
                                <label for="text">Skill Title :</label>
                                <input type="text" name="title" class="form-control" id="text">
                            </div>

                            <div class="form-group">
                                <label for="text">Skill Description:</label>
                                <textarea type="text" name="description" class="form-control" id="text"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="text">Skill Level :</label>
                                <input type="text" name="level" class="form-control" id="number" >
                            </div>
                            <div class="form-group">
                                <label for="text">Experience :</label>
                                <input type="text" name="exprience" class="form-control" id="number" >
                            </div>
                            <div class="form-group">
                                <label for="text">exprience area :</label>
                                <input type="text" name="exprience_area" class="form-control" id="number" >
                            </div>
