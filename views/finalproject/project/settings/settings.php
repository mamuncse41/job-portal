...
<!--                    <li class="active"><a data-toggle="tab" href="#home">Settings Edit</a></li>-->
                                ...
                                <table class="table" style="border: 1px solid #eee8d5"  >
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td ><img src="<?php echo "images/".$data['featured_img'];?>" width="60px"height="80px"/> </td>
                                            <td width="160px">
                                                <a href="edit_setting.php?id=<?php echo $data['id']; ?>"><input type="submit" value="Edit" class="btn btn-info"></a>
                                                <a href="delete.php?id=<?php echo $data['id'];?>"> <input type="submit" value="delete"  class="btn btn-danger"/></a>
                                            </td>
