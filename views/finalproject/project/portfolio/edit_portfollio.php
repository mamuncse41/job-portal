...
$data=$portfollio_obj->portfolios_edit();
...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="container">
                <a href="portfollio.php" class="btn btn-default btn-xs" data-toggle="tooltip" title="Back To List !">Back</a>
                <h2>Portfollio.</h2>
                <ul class="nav nav-tabs"></ul>

                <div class="tab-content">
                        <form  action="update_portfollios.php" enctype="multipart/form-data" method="post" style="width: 500px;align-items: center">
                            <div class="form-group">
                                <label for="text">Edit Portfollio Title :</label>
                                <input type="text" name="title" value="<?php echo $data['title']; ?>" class="form-control" id="text">
                            </div>

                            <div class="form-group">
                                <label for="text">Edit Portfollio Description:</label>
                                <textarea type="text" name="description" class="form-control" id="text"><?php echo $data['description']; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="text">Edit Portfollio Catagory :</label>
                                <input type="text" name="catagory"value="<?php echo $data['category']; ?>" class="form-control" id="number" >
                            </div>
                            <div class="form-group">
                                <label for="text">Change Portfollio Image use Browes button... :</label>
