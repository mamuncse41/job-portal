...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="container">
                <a href="award.php" class="btn btn-default btn-xs" data-toggle="tooltip" title="Back To List !">Back</a>
                <h2>Edit Award</h2>
                <ul class="nav nav-tabs"></ul>
                        <form  action="update_award.php" method="post" enctype="multipart/form-data" style="width: 500px;align-items: center">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="organization" value="<?php echo $data['organization'] ?>"  class="form-control" id="number" >
                            </div>
                            <div class="form-group">
                                <label for="text"> Description :</label>
                                <textarea  name="description" class="form-control" id="number"><?php echo $data['description'] ?> </textarea>
                            </div>
                            <div class="form-group">
                                <label for="text">Location:</label>
                                <input type="text" name="location" value="<?php echo $data['location'] ?>" class="form-control" id="number" >
                            </div>
                            <div class="form-group">
                                <label for="text">Year:</label>
                                <input type="text" name="year" value="<?php echo $data['year'] ?>"  class="form-control" id="number" ">
                            </div>
