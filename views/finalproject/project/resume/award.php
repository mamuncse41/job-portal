    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <a href="award.php" class="btn btn-default">Award</a></br></br>
                <ul class="nav nav-tabs"></ul>
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">View Award </a></li>
                    <li><a data-toggle="tab" href="#menu1"> Award Add </a></li>
                </ul>
                ...
                <div class="tab-content">
                                ...
                                <table class="table" style="border: 1px solid #eee8d5"  >
                                    ...
                                    foreach ($data as $key=>$value){
                                        ...
                                        <tr>
                                            ...
                                            <td width="170px">
                                                <a href="edit_award.php?id=<?php echo $value['id']; ?>"><input type="submit" value="Edit  .  .  " class="btn btn-info"></a>
                                                <a href="delete_award.php?id=<?php echo $value['id'];?>"> <input type="submit" value="delete"  class="btn btn-danger"/></a>
                                            </td>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <form  action="award_store.php" method="post" enctype="multipart/form-data" style="width: 500px;align-items: center">

                            <div class="form-group">
                                <label for="text">Enter Award Title :</label>
                                <input type="text" name="title" class="form-control" id="number" placeholder="Enter Award Title">
                            </div>
                            <div class="form-group">
                                <label for="text">Enter Award Organization :</label>
                                <input type="text" name="organization" class="form-control" id="number" placeholder="Enter Award Organization">
                            </div>
                            <div class="form-group">
                                <label for="text"> Description :</label>
                                <textarea  name="description" class="form-control" id="number"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="text">Location:</label>
                                <input type="datetime" name="location" class="form-control" id="number" placeholder="Enter Location">
                            </div>
                            <div class="form-group">
                                <label for="text">Year:</label>
                                <input type="text" name="year" class="form-control" id="number" placeholder="YY / MM / DD">
                            </div>
