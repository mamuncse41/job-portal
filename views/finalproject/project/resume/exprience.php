...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="container">
                <a href="education.php" class="btn btn-success">Education</a>
                <a href="exprience.php" class="btn btn-default">Experience</a>
                <a href="award.php" class="btn btn-info">Award</a></br></br>
                <ul class="nav nav-tabs"></ul>
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">View Exprience </a></li>
                    <li><a data-toggle="tab" href="#menu1"> Exprience Add </a></li>
                </ul>

                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <div class="container">
                            <p>Exprience Information..</p>
                                ...
                                <table class="table" style="border: 1px solid #eee8d5"  >
                                    ...
                                    foreach ($data as $key=>$value){
                                        ...
                                        <tr>
                                            ...
                                            <td width="170px">
                                                <a href="edit_exprience.php?id=<?php echo $value['id']; ?>"><input type="submit" value="Edit  .  .  " class="btn btn-info"></a>
                                                <a href="delete_Exprience.php?id=<?php echo $value['id'];?>"> <input type="submit" value="delete"  class="btn btn-danger"/></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <form  action="exprience_store.php" method="post" enctype="multipart/form-data" style="width: 500px;align-items: center">

                            <div class="form-group">
                                <label for="text">Enter Designation :</label>
                                <input type="text" name="designation" class="form-control" id="number" placeholder="Enter Designation">
                            </div>
                            <div class="form-group">
                                <label for="text">Enter Company Name :</label>
                                <input type="text" name="company_name" class="form-control" id="number" placeholder="Enter Company Name">
                            </div>
                            <div class="form-group">
                                <label for="text">Start Date :</label>
                                <input type="date"  name="start_date" class="form-control" id="number" placeholder="YY / MM / DD">
                            </div>
                            <div class="form-group">
                                <label for="text">End Date :</label>
                                <input type="date" name="end_date" class="form-control" id="number" placeholder="YY / MM / DD">
                            </div>
                            <div class="form-group">
                                <label for="text">Company Location:</label>
                                <input type="text" name="company_location" class="form-control" id="number" placeholder="Enter Company Location: ">
                            </div>
