...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="container">
                <a href="exprience.php" class="btn btn-default btn-xs" data-toggle="tooltip" title="Back To List !">Back</a>
                <h2>Edit Exprience</h2>
                <ul class="nav nav-tabs"></ul>
                        <form  action="update_exprience.php" method="post" enctype="multipart/form-data" style="width: 500px;align-items: center">

                            <div class="form-group">
                                <label for="text">Edit Designation :</label>
                                <input type="text" name="designation" value="<?php echo $data['designation']; ?>"class="form-control" id="number" ">
                            </div>
                            <div class="form-group">
                                <label for="text">Edit Company Name :</label>
                                <input type="text" name="company_name" value="<?php echo $data['company_name']; ?>" class="form-control" id="number" ">
                            </div>
                            <div class="form-group">
                                <label for="text"> Edit Start Date :</label>
                                <input type="date"  name="start_date" value="<?php echo $data['start_date']; ?>"class="form-control" id="number" ">
                            </div>
                            <div class="form-group">
                                <label for="text"> Edit End Date :</label>
                                <input type="date" name="end_date" value="<?php echo $data['end_date']; ?>"class="form-control" id="number" ">
                            </div>
                            <div class="form-group">
                                <label for="text"> Edit Company Location:</label>
                                <input type="text" name="company_location"value="<?php echo $data['company_location']; ?>" class="form-control" id="number"  ">
                            </div>
