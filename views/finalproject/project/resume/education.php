...
<div class="page-container">
    ...
    <div class="page-content">
        ...
        <div class="content-wrapper">
            ...
            <!-- Content area -->
            <div class="container">
                <a href="education.php" class="btn btn-default">Education</a>
                <a href="exprience.php" class="btn btn-primary">Experience</a>
                <a href="award.php" class="btn btn-info">Award</a></br></br>
                <ul class="nav nav-tabs"></ul>
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">View Education </a></li>
                    <li><a data-toggle="tab" href="#menu1"> Education Add </a></li>
                </ul>
                ...
                <div class="tab-content">
                                ...
                                <table class="table" style="border: 1px solid #eee8d5"  >
                                    ...
                                    foreach ($data as $key=>$value){
                                        ...
                                        <tr>
                                            ...
                                            <td width="170px">
                                                <a href="edit_education.php?id=<?php echo $value['id']; ?>"><input type="submit" value="Edit  .  .  " class="btn btn-info"></a>
                                                <a href="delete_education.php?id=<?php echo $value['id'];?>"> <input type="submit" value="delete"  class="btn btn-danger"/></a>
                                            </td>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <form  action="education_store.php" method="post" enctype="multipart/form-data" style="width: 500px;align-items: center">

                            <div class="form-group">
                                <label for="text">Enter Education Title :</label>
                                <input type="text" name="title" class="form-control" id="number" placeholder="Enter Teaching Title">
                            </div>
                            <div class="form-group">
                                <label for="text">Enter Education Institution :</label>
                                <input type="text" name="institute" class="form-control" id="number" placeholder="Enter Education Institution">
                            </div>
                            <div class="form-group">
                                <label for="text"> Result :</label>
                                <input type="text"  name="result" class="form-control" id="number" placeholder="Enter Result">
                            </div>
                            <div class="form-group">
                                <label for="text">Passing Year :</label>
                                <input type="datetime" name="passing_year" class="form-control" id="number" placeholder="YY / MM / DD">
                            </div>
                            <div class="form-group">
                                <label for="text">Enter Mejor Subject :</label>
                                <input type="text" name="main_subject" class="form-control" id="number" placeholder="Enter Mejor Subject ">
                            </div>
                            <div class="form-group">
                                <label for="text"> Education Board :</label>
                                <input type="text" name="board" class="form-control" id="number" placeholder="Education Board">
                            </div>
                            <div class="form-group">
                                <label for="text"> Course Duretion:</label>
                                <input type="text" name="course_duretion" class="form-control" id="number" placeholder="Course Duretion">
                            </div>
