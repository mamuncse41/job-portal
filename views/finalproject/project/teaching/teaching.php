        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">View Teaching </a></li>
                    <li><a data-toggle="tab" href="#menu1"> Teaching Add </a></li>
                </ul>
                ...
                <div class="tab-content">
                                ...
                                <table class="table" style="border: 1px solid #eee8d5"  >
                                    ...
                                    foreach ($data as $key=>$value){
                                        ...
                                        <tr>
                                            ...
                                            <td width="160px">
                                                <a href="teaching_edit.php?id=<?php echo $value['id']; ?>"><input type="submit" value="Edit" class="btn btn-info"></a>
                                                <a href="delete_teaching.php?id=<?php echo $value['id'];?>"> <input type="submit" value="delete"  class="btn btn-danger"/></a>
                                            </td>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <form  action="teaching_store.php" method="post" enctype="multipart/form-data" style="width: 500px;align-items: center">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="institute" class="form-control" id="number" placeholder="Enter Teaching Institution">
                            </div>
                            <div class="form-group">
                                <label for="text">Enter Description :</label>
                                <textarea  name="description" class="form-control" id="number" placeholder="Enter Teaching Institution"></textarea>
                            </div>
